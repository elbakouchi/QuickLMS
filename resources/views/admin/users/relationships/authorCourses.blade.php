...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-authorCourses">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  $('.datatable-authorCourses:not(.ajaxTable)').DataTable({ buttons: dtButtons })
